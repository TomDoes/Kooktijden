...
public class FragmentKookplaat6pits extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        timerHelper5.init(getActivity(),kookplaat5_progress,kookplaat5_text,kookplaat_plus);
        ...
        timerHelper6.init(getActivity(),kookplaat6_progress,kookplaat6_text,kookplaat_plus);
    }
}